...
/* 🆕 SIDEBAR RESPONSIVE - PLUS COMPACTE */
...
def generer_alerte(jours_restants):
    ...
    if jours_restants < 0: return f'<span class="jours-restants-urgent">🔴 ÉCHU depuis {-jours_restants} jour(s)</span>'
    elif jours_restants == 0: return f'<span class="jours-restants-urgent">🔴 AUJOURD\'HUI !</span>'
    elif jours_restants <= 15: return f'<span class="jours-restants-urgent">⚠️ Dans {jours_restants} jour(s)</span>'
    elif jours_restants <= 30: return f'<span class="jours-restants-warning">🟠 Dans {jours_restants} jour(s)</span>'
    else: return f'<span class="jours-restants-ok">✅ Dans {jours_restants} jour(s)</span>'
