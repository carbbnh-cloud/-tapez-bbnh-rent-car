...
# ============================================================
# CONFIGURATION SUPABASE (avec gestion d'erreur robuste)
# ============================================================
@st.cache_resource
def init_supabase():
    try:
...
if supabase is None:
    ...
    Créez un fichier `.streamlit/secrets.toml` à la racine du projet avec :
    ...
    Ou configurez les secrets dans Streamlit Cloud :
    **Settings → Secrets**
    """)
    st.stop()
